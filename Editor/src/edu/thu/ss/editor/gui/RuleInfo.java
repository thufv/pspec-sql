...
public class RuleInfo extends Dialog {
	...
	protected void createContents() {
		...
		lbl_RuleID.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		lbl_DataCateRefType.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		lbl_RestrType.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
