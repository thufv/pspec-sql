...
public class RuleEdit extends Dialog {
	...
	protected void createContents() {
		...
		lbl_UserRefTitle.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.BOLD));
		...
		label_1.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.BOLD));
		...
		lblRestriction.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.BOLD));
	...
	private void userPart() {
		...
		lbl_UserRefID.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		lbl_UserEclud.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
	...
	private void dataPart(){
		...
		label_2.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		label_4.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		label_3.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
