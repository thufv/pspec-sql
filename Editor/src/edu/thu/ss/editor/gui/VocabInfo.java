...
public class VocabInfo extends Composite {
	...
	public VocabInfo(Shell shell_ , Composite parent, int style) {
		...
		lbl_empty.setText("        ");
		lbl_empty.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		lbl_vocabID.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		lbl_empty1.setText("                                 ");
		lbl_empty1.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		lbl_Location.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		lbl_Issuer.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		lbl_Name.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		lbl_Organiz.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		lbl_Email.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		lbl_Addr.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
		...
		lbl_Country.setFont(SWTResourceManager.getFont("Microsoft YaHei UI", 8, SWT.NORMAL));
