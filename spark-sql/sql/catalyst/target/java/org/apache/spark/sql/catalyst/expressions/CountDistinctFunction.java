...
public  class CountDistinctFunction extends org.apache.spark.sql.catalyst.expressions.AggregateFunction implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   CountDistinctFunction (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> expr, org.apache.spark.sql.catalyst.expressions.AggregateExpression base) { throw new RuntimeException(); }
  public   CountDistinctFunction () { throw new RuntimeException(); }
