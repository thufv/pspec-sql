...
private  class ParquetTypesConverter implements org.apache.spark.Logging {
  ...
  static public  org.apache.spark.sql.catalyst.types.DataType toPrimitiveDataType (parquet.schema.PrimitiveType parquetType, boolean binayAsString) { throw new RuntimeException(); }
  /**
   ...
   */
  static public  scala.Option<scala.Tuple2<parquet.schema.PrimitiveType.PrimitiveTypeName, scala.Option<parquet.schema.OriginalType>>> fromPrimitiveDataType (org.apache.spark.sql.catalyst.types.DataType ctype) { throw new RuntimeException(); }
  /**
