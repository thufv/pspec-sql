...
private  class JsonRDD implements org.apache.spark.Logging {
  static private  org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.expressions.Row> jsonStringToRow (org.apache.spark.rdd.RDD<java.lang.String> json, org.apache.spark.sql.catalyst.types.StructType schema) { throw new RuntimeException(); }
  static private  org.apache.spark.sql.catalyst.types.StructType inferSchema (org.apache.spark.rdd.RDD<java.lang.String> json, double samplingRatio) { throw new RuntimeException(); }
  ...
  static private  org.apache.spark.sql.catalyst.types.StructType nullTypeToStringType (org.apache.spark.sql.catalyst.types.StructType struct) { throw new RuntimeException(); }
  /**
   * Returns the most general data type for two given data types.
   */
  static private  org.apache.spark.sql.catalyst.types.DataType compatibleType (org.apache.spark.sql.catalyst.types.DataType t1, org.apache.spark.sql.catalyst.types.DataType t2) { throw new RuntimeException(); }
  ...
  static private  org.apache.spark.rdd.RDD<scala.collection.Map<java.lang.String, java.lang.Object>> parseJson (org.apache.spark.rdd.RDD<java.lang.String> json) { throw new RuntimeException(); }
  ...
  static private  scala.math.BigDecimal toDecimal (Object value) { throw new RuntimeException(); }
  ...
  static private  Object enforceCorrectType (Object value, org.apache.spark.sql.catalyst.types.DataType desiredType) { throw new RuntimeException(); }
