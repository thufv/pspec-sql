...
private  class DictionaryEncoding$ implements org.apache.spark.sql.columnar.compression.CompressionScheme, scala.Product, scala.Serializable {
  ...
  public <T extends org.apache.spark.sql.catalyst.types.NativeType> org.apache.spark.sql.columnar.compression.DictionaryEncoding.Encoder<T> encoder () { throw new RuntimeException(); }
