...
public  class ParquetFilters {
  ...
  static public  parquet.filter.UnboundRecordFilter createRecordFilter (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> filterExpressions) { throw new RuntimeException(); }
  static public  scala.Option<org.apache.spark.sql.parquet.CatalystFilter> createFilter (org.apache.spark.sql.catalyst.expressions.Expression expression) { throw new RuntimeException(); }
  /**
   ...
   */
  static public  scala.Option<org.apache.spark.sql.parquet.CatalystFilter> findExpression (org.apache.spark.sql.parquet.CatalystFilter filter, org.apache.spark.sql.catalyst.expressions.Expression expression) { throw new RuntimeException(); }
}
