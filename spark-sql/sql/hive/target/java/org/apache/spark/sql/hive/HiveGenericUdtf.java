 ...
 */
private  class HiveGenericUdtf extends org.apache.spark.sql.catalyst.expressions.Generator implements org.apache.spark.sql.hive.HiveInspectors, org.apache.spark.sql.hive.HiveFunctionFactory, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   HiveGenericUdtf (java.lang.String functionClassName, scala.collection.Seq<java.lang.String> aliasNames, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> children) { throw new RuntimeException(); }
  ...
  protected  scala.collection.mutable.Buffer<org.apache.hadoop.hive.serde2.objectinspector.ObjectInspector> outputInspectors () { throw new RuntimeException(); }
