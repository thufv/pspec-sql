 ...
 */
private  class HadoopTableReader implements org.apache.spark.sql.hive.TableReader {
  /**
   ...
   */
  static public  scala.collection.Iterator<org.apache.spark.sql.catalyst.expressions.Row> fillObject (scala.collection.Iterator<org.apache.hadoop.io.Writable> iter, org.apache.hadoop.hive.serde2.Deserializer deserializer, scala.collection.Seq<scala.Tuple2<org.apache.spark.sql.catalyst.expressions.Attribute, java.lang.Object>> attrs, org.apache.spark.sql.catalyst.expressions.GenericMutableRow row) { throw new RuntimeException(); }
  public   HadoopTableReader (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> attributes, org.apache.spark.sql.hive.MetastoreRelation relation, org.apache.spark.sql.hive.HiveContext sc) { throw new RuntimeException(); }
  ...
  public  org.apache.spark.broadcast.Broadcast<org.apache.spark.SerializableWritable<org.apache.hadoop.hive.conf.HiveConf>> broadcastedHiveConf () { throw new RuntimeException(); }
  public  org.apache.hadoop.hive.conf.HiveConf hiveConf () { throw new RuntimeException(); }
