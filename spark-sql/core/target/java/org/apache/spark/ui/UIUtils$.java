...
private  class UIUtils$ implements org.apache.spark.Logging {
  ...
  public  java.lang.String TABLE_CLASS () { throw new RuntimeException(); }
  ...
  public  scala.collection.Seq<scala.xml.Node> headerSparkPage (java.lang.String title, scala.Function0<scala.collection.Seq<scala.xml.Node>> content, org.apache.spark.ui.SparkUITab activeTab, scala.Option<java.lang.Object> refreshInterval) { throw new RuntimeException(); }
  ...
  public <T extends java.lang.Object> scala.collection.Seq<scala.xml.Node> listingTable (scala.collection.Seq<java.lang.String> headers, scala.Function1<T, scala.collection.Seq<scala.xml.Node>> generateDataRow, scala.collection.Seq<T> data, boolean fixedWidth) { throw new RuntimeException(); }
}
