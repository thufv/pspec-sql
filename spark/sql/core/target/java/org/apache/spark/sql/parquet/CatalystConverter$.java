...
public  class CatalystConverter$ {
  ...
  public  java.lang.String THRIFT_ARRAY_ELEMENTS_SCHEMA_NAME_SUFFIX () { throw new RuntimeException(); }
  ...
  protected  parquet.io.api.Converter createConverter (org.apache.spark.sql.types.StructField field, int fieldIndex, org.apache.spark.sql.parquet.CatalystConverter parent) { throw new RuntimeException(); }
