...
public  class CatalystArrayContainsNullConverter extends org.apache.spark.sql.parquet.CatalystConverter {
  ...
  // not preceding
  public   CatalystArrayContainsNullConverter (org.apache.spark.sql.types.DataType elementType, int index, org.apache.spark.sql.parquet.CatalystConverter parent, scala.collection.mutable.Buffer<java.lang.Object> buffer) { throw new RuntimeException(); }
  public   CatalystArrayContainsNullConverter (org.apache.spark.sql.types.DataType elementType, int index, org.apache.spark.sql.parquet.CatalystConverter parent) { throw new RuntimeException(); }
