...
// no position
public  class LONG extends org.apache.spark.sql.columnar.NativeColumnType<org.apache.spark.sql.types.LongType$> {
  ...
  static public  long getField (org.apache.spark.sql.Row row, int ordinal) { throw new RuntimeException(); }
