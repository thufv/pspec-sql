...
public  class CatalystPrimitiveRowConverter extends org.apache.spark.sql.parquet.CatalystConverter {
  ...
  // not preceding
  public   CatalystPrimitiveRowConverter (org.apache.spark.sql.types.StructField[] schema, org.apache.spark.sql.catalyst.expressions.MutableRow current) { throw new RuntimeException(); }
