...
// no position
public  class BYTE extends org.apache.spark.sql.columnar.NativeColumnType<org.apache.spark.sql.types.ByteType$> {
  ...
  static public  byte getField (org.apache.spark.sql.Row row, int ordinal) { throw new RuntimeException(); }
