...
public  class CatalystArrayConverter extends org.apache.spark.sql.parquet.CatalystConverter {
  ...
  // not preceding
  public   CatalystArrayConverter (org.apache.spark.sql.types.DataType elementType, int index, org.apache.spark.sql.parquet.CatalystConverter parent, scala.collection.mutable.Buffer<java.lang.Object> buffer) { throw new RuntimeException(); }
  public   CatalystArrayConverter (org.apache.spark.sql.types.DataType elementType, int index, org.apache.spark.sql.parquet.CatalystConverter parent) { throw new RuntimeException(); }
