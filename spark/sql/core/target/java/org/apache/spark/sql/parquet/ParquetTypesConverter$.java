...
public  class ParquetTypesConverter$ implements org.apache.spark.Logging {
  ...
  public  org.apache.spark.sql.types.DataType toPrimitiveDataType (parquet.schema.PrimitiveType parquetType, boolean binaryAsString, boolean int96AsTimestamp) { throw new RuntimeException(); }
  /**
   ...
   */
  public  org.apache.spark.sql.types.DataType toDataType (parquet.schema.Type parquetType, boolean isBinaryAsString, boolean isInt96AsTimestamp) { throw new RuntimeException(); }
  /**
   ...
   */
  public  scala.Option<org.apache.spark.sql.parquet.ParquetTypeInfo> fromPrimitiveDataType (org.apache.spark.sql.types.DataType ctype) { throw new RuntimeException(); }
  /**
   ...
   */
  public  parquet.schema.Type fromDataType (org.apache.spark.sql.types.DataType ctype, java.lang.String name, boolean nullable, boolean inArray, boolean toThriftSchemaNames) { throw new RuntimeException(); }
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> convertToAttributes (parquet.schema.Type parquetSchema, boolean isBinaryAsString, boolean isInt96AsTimestamp) { throw new RuntimeException(); }
  public  parquet.schema.MessageType convertFromAttributes (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> attributes, boolean toThriftSchemaNames) { throw new RuntimeException(); }
   ...
   */
  public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> readSchemaFromFile (org.apache.hadoop.fs.Path origPath, scala.Option<org.apache.hadoop.conf.Configuration> conf, boolean isBinaryAsString, boolean isInt96AsTimestamp) { throw new RuntimeException(); }
}
