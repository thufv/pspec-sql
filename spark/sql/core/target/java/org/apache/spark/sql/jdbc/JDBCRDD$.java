...
// no position
public  class JDBCRDD$ implements org.apache.spark.Logging, scala.Serializable {
  /**
   ...
   */
  private  org.apache.spark.sql.types.DataType getCatalystType (int sqlType) { throw new RuntimeException(); }
  /**
   ...
   */
  public  org.apache.spark.sql.types.StructType resolveTable (java.lang.String url, java.lang.String table) { throw new RuntimeException(); }
  /**
   ...
   */
  public  scala.Function0<java.sql.Connection> getConnector (java.lang.String driver, java.lang.String url) { throw new RuntimeException(); }
  /**
