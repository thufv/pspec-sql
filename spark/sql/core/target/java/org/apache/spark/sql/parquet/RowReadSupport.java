 ...
 */
public  class RowReadSupport extends parquet.hadoop.api.ReadSupport<org.apache.spark.sql.Row> implements org.apache.spark.Logging {
  ...
  public  parquet.io.api.RecordMaterializer<org.apache.spark.sql.Row> prepareForRead (org.apache.hadoop.conf.Configuration conf, java.util.Map<java.lang.String, java.lang.String> stringMap, parquet.schema.MessageType fileSchema, parquet.hadoop.api.ReadSupport.ReadContext readContext) { throw new RuntimeException(); }
