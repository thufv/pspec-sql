...
// no position
public  class SHORT extends org.apache.spark.sql.columnar.NativeColumnType<org.apache.spark.sql.types.ShortType$> {
  ...
  static public  short getField (org.apache.spark.sql.Row row, int ordinal) { throw new RuntimeException(); }
