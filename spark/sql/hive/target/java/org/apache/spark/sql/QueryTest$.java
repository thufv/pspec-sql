...
public  class QueryTest$ implements scala.Serializable {
   ...
   */
  public  scala.Option<java.lang.String> checkAnswer (org.apache.spark.sql.DataFrame rdd, scala.collection.Seq<org.apache.spark.sql.Row> expectedAnswer) { throw new RuntimeException(); }
  public  java.lang.String checkAnswer (org.apache.spark.sql.DataFrame rdd, java.util.List<org.apache.spark.sql.Row> expectedAnswer) { throw new RuntimeException(); }
}
