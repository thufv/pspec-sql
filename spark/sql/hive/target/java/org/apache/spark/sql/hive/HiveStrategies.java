...
public  interface HiveStrategies {
  ...
  public  class ParquetConversion extends org.apache.spark.sql.catalyst.planning.GenericStrategy<org.apache.spark.sql.execution.SparkPlan> {
    ...
    public  class LogicalPlanHacks {
      public   LogicalPlanHacks (org.apache.spark.sql.DataFrame s) { throw new RuntimeException(); }
      public  org.apache.spark.sql.DataFrame lowerCase () { throw new RuntimeException(); }
      public  org.apache.spark.sql.DataFrame addPartitioningAttributes (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> attrs) { throw new RuntimeException(); }
    }
