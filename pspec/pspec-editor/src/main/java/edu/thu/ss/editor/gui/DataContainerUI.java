...
import edu.thu.ss.editor.CategoryFactory.DataCategoryFactory;
...
public class DataContainerUI extends Composite {

	protected static Shell shell;

	private ArrayList<DataCategory> dataCategoryList;
	 ...
	 * @param style
	 */
	public DataContainerUI(Shell shell_, Composite parent, int style) {
		super(parent, SWT.NONE);
		shell = shell_;
		setLayout(new BorderLayout(0, 0));

		ToolBar toolBar_DataContainer = new ToolBar(this, SWT.FLAT | SWT.RIGHT | SWT.SHADOW_OUT);
		toolBar_DataContainer.setEnabled(false);
		toolBar_DataContainer.setForeground(SWTResourceManager.getColor(SWT.COLOR_WIDGET_FOREGROUND));
		toolBar_DataContainer.setBackground(SWTResourceManager
				.getColor(SWT.COLOR_TITLE_INACTIVE_BACKGROUND_GRADIENT));
		toolBar_DataContainer.setLayoutData(BorderLayout.NORTH);

		ToolItem tltm__DataContainer = new ToolItem(toolBar_DataContainer, SWT.NONE);
		tltm__DataContainer.setEnabled(false);
		tltm__DataContainer.setText("DataContainer");
		...
		tree.setFont(EditorConstant.getDefaultFont());
		...
		treeViewer.setInput(dataCategoryList);
		...
		lbl_containerID.setFont(EditorConstant.getDefaultFont());
		lbl_containerID.setBackground(SWTResourceManager.getColor(SWT.COLOR_WHITE));
		lbl_containerID.setText("*Data Container ID\uFF1A");
		...
		lbl_baseId.setFont(EditorConstant.getDefaultFont());
		...
		lbl_categoryID.setFont(EditorConstant.getDefaultFont());
		lbl_categoryID.setText("*Data Category ID : ");
		...
		lbl_categoryIDContent.setFont(EditorConstant.getDefaultFont());
		...
		lbl_parenID.setFont(EditorConstant.getDefaultFont());
		...
		lbl_parenIDContent.setFont(EditorConstant.getDefaultFont());
		...
		lbl_shortDesDown.setFont(EditorConstant.getDefaultFont());
		...
		lbl_shortDesDownContent
				.setFont(EditorConstant.getDefaultFont());
		...
		lbl_longDesDown.setFont(EditorConstant.getDefaultFont());
		...
		lbl_longDesDowncontent.setFont(EditorConstant.getDefaultFont());
		...
		addItem.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent event) {
				...
				if (!category.getText().equals("Root"))
					dataCategory.setParentId(category.getText());
				new DataCategoryUI(shell, dataCategory).open();
			}
		});
