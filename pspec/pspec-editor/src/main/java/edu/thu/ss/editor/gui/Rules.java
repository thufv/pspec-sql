...
public class Rules extends Composite {
	...
	public Rules(Shell shell_, Composite parent, int style) {
		...
		lbl_empty.setFont(EditorConstant.getDefaultBoldFont());
		...
		lbl_title.setFont(EditorConstant.getDefaultBoldFont());
		...
		expandBar.setFont(EditorConstant.getDefaultBoldFont());
	...
	private void creatRuleOverview(boolean reatricType) {
		...
		composite_info.setFont(EditorConstant.getDefaultFont());
		...
		lbl_UserRef.setFont(EditorConstant.getDefaultBoldFont());
		...
		for (int i = 0; i < 2; i++) {
			...
			lbl_UserRefContent.setFont(EditorConstant.getDefaultFont());
		...
		lbl_DataRef.setFont(EditorConstant.getDefaultBoldFont());
		...
		for (int i = 0; i < 2; i++) {
			...
			lbl_DataRefContent.setFont(EditorConstant.getDefaultFont());
			...
			lbl_cut.setFont(EditorConstant.getDefaultFont());
			...
			lbl_Action.setFont(EditorConstant.getDefaultFont());
		...
		if (reatricType) {
			...
			lblRestrictionforbid.setFont(EditorConstant.getDefaultBoldFont());
			...
			lblRestrictionassociation
					.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false, false, 7, 1));
			lblRestrictionassociation.setText("Restriction:");
			lblRestrictionassociation.setFont(EditorConstant.getDefaultBoldFont());
			...
			for (int i = 0; i < 2; i++) {
				...
				lbl_Desens.setFont(EditorConstant.getDefaultFont());
				...
				lbl_refData.setFont(EditorConstant.getDefaultFont());
				...
				lbl_operat.setFont(EditorConstant.getDefaultFont());
