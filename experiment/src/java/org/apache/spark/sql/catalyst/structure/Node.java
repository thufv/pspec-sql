...
public class Node<T> implements Comparable<Node<T>> {
  ...
  public int compareTo(final Node<T> argNode) {
    return this.name.equals(argNode.name) ? 0 : -1;
  }
  ...
  public boolean equals(Object otherObject) {
    ...
    Node<T> otherA = (Node<T>) otherObject;
    return this.name.equals(otherA.getName());
  }
  ...
  public String toString() {
    ...
    String s = "[Name " + this.name + NEW_LINE + " index: " + this.index + NEW_LINE + " visited : "
        + this.visited + NEW_LINE + " lowlink: " + this.lowlink + "]" + NEW_LINE;
    result.append(s);
